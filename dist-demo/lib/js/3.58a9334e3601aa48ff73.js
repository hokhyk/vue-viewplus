...
// module
exports.push([module.i, "", "", {"version":3,"sources":[],"names":[],"mappings":"","file":"Page1.vue","sourceRoot":""}]);
...
var isEmpty = __webpack_require__("lHK6");
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./examples/components/Demo/PageStack/Page1.vue
...
/* harmony default export */ var Page1 = ({
  ...
  methods: {
    showStackList: function showStackList() {
      ...
      if (has_default()(this.params, 'phoneNumb')) {
        this.dataParams.phoneNumb = this.params.phoneNumb;
      }
      if (!isEmpty_default()(this.backParams)) {
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./examples/components/Demo/PageStack/Page1.vue
...
/* harmony default export */ var PageStack_Page1 = ({
  mixins: [main["b" /* paramsStack */], demo_mixin["a" /* default */]],
  components: {
    XInput: x_input["a" /* default */],
    FormPreview: form_preview["a" /* default */]
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-2d929a98","hasScoped":true,"optionsId":"0","buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./examples/components/Demo/PageStack/Page1.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('group',{staticClass:"bottom-group",attrs:{"title":"模拟手机号充值 - 堆栈底-第一页","label-width":"5em"}},[_c('box',{attrs:{"gap":"10px 10px"}},[_c('x-input',{attrs:{"title":"手机号"},model:{value:(_vm.dataParams.phoneNumb),callback:function ($$v) {_vm.$set(_vm.dataParams, "phoneNumb", $$v)},expression:"dataParams.phoneNumb"}})],1),_vm._v(" "),_c('box',{attrs:{"gap":"10px 10px"}},[_c('x-button',{attrs:{"plain":""},nativeOn:{"click":function($event){_vm.submit()}}},[_vm._v("点击充值")]),_vm._v(" "),_c('x-button',{attrs:{"plain":""},nativeOn:{"click":function($event){_vm.modify()}}},[_vm._v("修改参数栈内参数对象")])],1),_vm._v(" "),_c('form-preview',{attrs:{"header-label":"参数栈回显","body-items":_vm.stackList}}),_vm._v(" "),_c('cell-box',[_c('pre',{directives:[{name:"highlightjs",rawName:"v-highlightjs"}]},[_c('code',{staticClass:"javascript"},[_vm._v("\nimport demoMixin from '../demo-mixin'\nimport { XInput, FormPreview } from 'vux'\nimport { paramsStack } from 'vue-viewplus'\nimport _ from 'lodash'\n\nexport default {\n  mixins: [paramsStack, demoMixin],\n  components: {\n    XInput,\n    FormPreview\n  },\n  data() {\n    return {\n      stackList: [\n        {\n          label: 'params',\n          value: {}\n        },\n        {\n          label: 'backParams',\n          value: {}\n        }\n      ],\n      isStackBottom: true,\n      dataParams: {\n        phoneNumb: ''\n      }\n    }\n  },\n  methods: {\n    showStackList() {\n      this.stackList[0].value = JSON.stringify(this.params, null, 2)\n      if (_.has(this.params, 'phoneNumb')) {\n        this.dataParams.phoneNumb = this.params.phoneNumb\n      }\n      this.stackList[1].value = JSON.stringify(this.backParams, null, 2)\n      if (!_.isEmpty(this.backParams)) {\n        this.dataParams.phoneNumb = this.backParams.phoneNumb\n        this.$vp.toast(`通过 backParams.phoneNumb 预填写页面`)\n      }\n    },\n    submit() {\n      console.log('充值录入数据：', JSON.stringify(this.dataParams))\n      this.$vp.psPageNext('/Demo/PageStack/Page2', {\n        params: this.dataParams\n      })\n    }\n  },\n  beforeRouteEnter(to, from, next) {\n    next(vm => {\n      // 通过 `vm` 访问组件实例\n      // 由于该页面被复用，故如果需要获取到`Page2`设置的`this.backParams.phoneNumb`需要定义当前路由守卫来捕获该时机\n      // 但是在当前实例中，`this.backParams`其实已经被赋值为`phoneNumb: '18888888888'`\n      vm.showStackList()\n    })\n  },\n  created() {\n    console.log('this.params', this.params)\n    this.showStackList()\n    // 声明该页面是栈底部\n    this.isStackBottom = true\n  }\n}\n  ")])])])],1)}
var staticRenderFns = []

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/component-normalizer.js
var component_normalizer = __webpack_require__("XyMi");

// CONCATENATED MODULE: ./examples/components/Demo/PageStack/Page1.vue
function injectStyle (context) {
  __webpack_require__("sx7q")
}
/* script */
...
/* scopeId */
var __vue_scopeId__ = "data-v-2d929a98"
...
/* harmony default export */ var Demo_PageStack_Page1 = __webpack_exports__["default"] = (Component.exports);
...
// load the styles
var content = __webpack_require__("8qDl");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("rjj0").default
var update = add("de6ce424", content, true, {});
