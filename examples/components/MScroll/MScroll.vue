<template>
  <div ref="wrapper" class="vp-list-wrapper">
    <div ref="content" class="scroll-content">
      <div ref="listWrapper">
        <slot></slot>
      </div>
      <slot name="pullup" :pullUpLoad="pullUpLoad" :isPullUpLoad="isPullUpLoad">
        <div class="vp-pullup-wrapper" v-if="pullUpLoad">
    ...
    <slot name="pulldown" :pullDownRefresh="pullDownRefresh" :pullDownStyle="pullDownStyle" :beforePullDown="beforePullDown" :isPullingDown="isPullingDown" :bubbleY="bubbleY">
      <div ref="pulldown" class="vp-pulldown-wrapper" :style="pullDownStyle" v-if="pullDownRefresh">
  ...
  export default {
    ...
    methods: {
      initScroll() {
        ...
        this.$refs.wrapper.style.height = (getRect(this.$refs.wrapper).height - this.top - this.bottom - this.loadingStyleHeight) + 'px'
